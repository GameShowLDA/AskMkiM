...
namespace Ask.UI.Features.Archive.Services
{
  ...
  public class ArchiveCreationService
  {
    ...
    /// <summary>
    /// Создаёт новый архив, записывает манифест и выполняет шифрование файла.
    /// </summary>
    /// <param name="archiveName">Имя создаваемого архива.</param>
    /// <returns>Полный путь к созданному архиву.</returns>
    ...
    /// <summary>
    /// Нормализует имя архива, удаляет расширение и заменяет недопустимые символы.
    /// </summary>
    /// <param name="archiveName">Исходное имя архива.</param>
    /// <returns>Корректное имя архива для файловой системы.</returns>
