...
{
  /// <summary>
  /// Выполняет сохранение и экспорт архивов.
  /// </summary>
  public sealed class ArchiveSaveService
  {
    /// <summary>
    /// Возможные директории для сохранения архивов.
    /// </summary>
    ...
    /// <summary>
    /// Сохраняет набор команд в выбранный архив.
    /// </summary>
    /// <param name="ownerElement">Родительский UI-элемент для отображения диалогов.</param>
    /// <param name="models">Коллекция моделей команд для сохранения.</param>
    ...
    /// <summary>
    /// Сохраняет текст перевода в выбранный архив.
    /// </summary>
    /// <param name="ownerElement">Родительский UI-элемент для отображения диалогов.</param>
    /// <param name="translatedText">Текст перевода для сохранения.</param>
    /// <param name="sourceFilePath">Путь к исходному файлу.</param>
    /// <returns>
    /// true, если сохранение выполнено успешно;
    /// иначе false.
    ...
    /// <summary>
    /// Возвращает путь к архиву, выбранному пользователем для сохранения файла.
    /// </summary>
    /// <param name="ownerElement">Родительский UI-элемент для отображения диалога.</param>
    /// <param name="suggestedArchiveName">Рекомендуемое имя архива.</param>
    /// <returns>Путь к выбранному архиву или null.</returns>
    ...
    //TODO : Почему это не элемент управления?
    /// <summary>
    /// Отображает диалог выбора архива для сохранения файла.
    /// </summary>
    /// <param name="ownerElement">Родительский UI-элемент для отображения диалога.</param>
    /// <param name="archivePaths">Список доступных архивов.</param>
    /// <param name="archivesFolderPath">Путь к директории архивов.</param>
    /// <param name="suggestedArchiveName">Рекомендуемое имя нового архива.</param>
    /// <returns>Путь к выбранному архиву или null.</returns>
    ...
    //TODO : Почему это не элемент управления?
    /// <summary>
    /// Отображает диалог ввода имени нового архива.
    /// </summary>
    /// <param name="ownerElement">Родительский UI-элемент для отображения диалога.</param>
    /// <param name="suggestedArchiveName">Рекомендуемое имя архива.</param>
    /// <param name="isFirstArchive">
    /// Признак того, что архив создаётся первым в списке.
    /// </param>
    /// <returns>Имя архива, введённое пользователем, или null.</returns>
    ...
    /// <summary>
    /// Создаёт новый архив в указанной директории и публикует событие создания.
    /// </summary>
    /// <param name="archivesFolderPath">Путь к директории архивов.</param>
    ...
    /// <summary>
    /// Нормализует имя архива и заменяет недопустимые символы.
    /// </summary>
    /// <param name="archiveName">Исходное имя архива.</param>
    /// <returns>Нормализованное имя архива.</returns>
    ...
    //TODO : Почему это не элемент управления?
    /// <summary>
    /// Применяет стиль оформления к кнопке диалога.
    /// </summary>
    /// <param name="ownerElement">Элемент-владелец для поиска ресурсов.</param>
    ...
    /// <summary>
    /// Возвращает кисть темы по ключу или создаёт резервную кисть.
    /// </summary>
    /// <param name="ownerElement">Элемент-владелец для поиска ресурсов.</param>
    /// <param name="key">Ключ ресурса кисти.</param>
    /// <param name="fallbackColor">Резервный цвет при отсутствии ресурса.</param>
    /// <returns>Найденная или созданная кисть.</returns>
    ...
    /// <summary>
    /// Отображает уведомление, связанное с операциями архивов.
    /// </summary>
    ...
    /// <summary>
    /// Преобразует исключение в понятное пользователю сообщение об ошибке сохранения.
    /// </summary>
    /// <param name="ex">Исключение, возникшее при сохранении.</param>
    ...
    /// <summary>
    /// Преобразует исключение в понятное пользователю сообщение об ошибке создания архива.
    /// </summary>
    /// <param name="ex">Исключение, возникшее при создании архива.</param>
    /// <returns>Сообщение об ошибке для отображения пользователю.</returns>
    ...
    /// <summary>
    /// Представляет вариант директории архивов для выбора пользователем.
    /// </summary>
    private sealed class ArchiveDirectoryOption
    {
      /// <summary>
      /// Инициализирует описание директории архивов.
      /// </summary>
      /// <param name="displayName">Отображаемое имя директории.</param>
