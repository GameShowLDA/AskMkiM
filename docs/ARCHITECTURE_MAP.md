...
| `ExecutionMessages` | static facade | Ask.Protocol.Messages | проверяет видимость параметров выполнения, формирует и выводит сообщения подготовки устройств и настройки измерительного оборудования; модели наружу не возвращает | [Protocols](#protocols-and-file-formats) |
