...
| `ValidationMessages` | static facade | Ask.Protocol.Messages | публикует ошибки полей ввода, отсутствующего выбранного устройства и измерителя самоконтроля | [Protocols](#protocols-and-file-formats) |
| `ValidationMessageBuilder` | internal static builder | Ask.Protocol.Messages | формирует сообщения об ошибках полей облегчённого ввода и зависимостей запуска самоконтроля | [Protocols](#protocols-and-file-formats) |
