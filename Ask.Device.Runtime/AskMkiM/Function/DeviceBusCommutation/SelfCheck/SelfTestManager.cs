...
namespace Ask.Device.Runtime.AskMkiM.Function.DeviceBusCommutation.SelfCheck
{
  public class SelfTestManager : ISelfTestCheckerDeviceBusCommutation
  {
    ...
    public SelfTestManager(Device.SwitchingDevice.DeviceBusCommutation deviceBusCommutation) => _deviceBusCommutation = deviceBusCommutation;
    ...
    /// <inheritdoc />
    public Task StartSelfCheck(CancellationToken cancellationToken, Enum selectedType, IUserInteractionService? userMessageService = null, ISwitchingDevice device = null, IMultimeter meter = null) => SelfTestProcessManager.StartSelfCheck(cancellationToken, userMessageService, selectedType, device, meter);
