...
namespace Ask.Device.Runtime.AskMkiM.Function.ModuleVoltageCurrentSource.SelfCheck
{
  public class SelfTestManager : ISelfTestCheckerModuleVoltageCurrentSource
  {
    ...
    /// <inheritdoc />
    public async Task StartSelfCheck(CancellationToken cancellationToken, IUserInteractionService messageService, Enum selectedType, ISwitchingDevice dbc = null, IPowerSourceModule powerDevice = null, IMultimeter meter = null)
    {
