...
using static Ask.Device.Runtime.AskMkiM.Function.GPT.Command.ManualCommandManager;
using static Ask.Device.Runtime.AskMkiM.Function.GPT.Command.SystemCommandManager;

namespace Ask.Device.Runtime.AskMkiM.Function.GPT
{
  /// <summary>
