    ...
    private static readonly IReadOnlyDictionary<string, DeviceHelpInfo> Devices =
      new Dictionary<string, DeviceHelpInfo>(StringComparer.OrdinalIgnoreCase)
      {
        ...
        ["DBC"] = Create(
          ...
          Command(7, "Подключить или отключить все шины", "7.a.0.0.",
            "a: 1 — подключить, 2 — отключить"),
          Command(8, "Подключить или отключить реле", "8.a.b.0.",
            "a: номер реле; b: 1 — подключить, 2 — отключить"),
          Command(9, "Общие реле и делитель", "9.a.0.c.",
            "a: 1 — общие реле, 2 — делитель; c: 1 — включить, 2 — отключить")),
        ["MS"] = Create(
          "МШ",
          Command(1, "Инициализация", "1.0.0.0."),
          Command(21, "Включить источники 3/4", "2.1.1.0."),
          Command(22, "Выключить источники 3/4", "2.2.1.0."),
          Command(3, "Установить напряжение", "3.a.b.0.",
            "a: целая часть напряжения; b: дробная часть"),
          Command(4, "Установить ток", "4.a.b.0.",
            "a: целая часть тока; b: дробная часть"),
          Command(5, "Подключить или отключить шину к плюсу", "5.a.b.c.",
            "a/b: тип и номер шины; c: 1 — подключить, 2 — отключить"),
          Command(6, "Подключить или отключить шину к минусу", "6.a.b.c.",
            "a/b: тип и номер шины; c: 1 — подключить, 2 — отключить"),
          Command(7, "Проверить питание", "7.0.0.0."),
          Command(9, "Выбрать источник напряжения", "9.a.0.0.",
            "a: 0 — 5 В, 1 — 12 В"),
          Command(10, "Установить ограничение тока", "10.a.0.0.",
            "a: ограничение тока в мА"))
      };
