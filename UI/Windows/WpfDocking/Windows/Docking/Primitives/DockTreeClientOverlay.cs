...
namespace UI.Windows.WpfDocking.Windows.Docking.Primitives
{
  ...
  public class DockTreeClientOverlay : Control
  {
    ...
    private static readonly DependencyPropertyKey LeftTreeWidthPropertyKey = DependencyProperty.RegisterReadOnly("LeftTreeWidth", typeof(GridLength), typeof(DockTreeClientOverlay),
    ...
    private static readonly DependencyPropertyKey RightTreeWidthPropertyKey = DependencyProperty.RegisterReadOnly("RightTreeWidth", typeof(GridLength), typeof(DockTreeClientOverlay),
        new FrameworkPropertyMetadata());
    ...
    private static readonly DependencyPropertyKey TopTreeHeightPropertyKey = DependencyProperty.RegisterReadOnly("TopTreeHeight", typeof(GridLength), typeof(DockTreeClientOverlay),
        new FrameworkPropertyMetadata());
    ...
    private static readonly DependencyPropertyKey BottomTreeHeightPropertyKey = DependencyProperty.RegisterReadOnly("BottomTreeHeight", typeof(GridLength), typeof(DockTreeClientOverlay),
        new FrameworkPropertyMetadata());
    ...
    private static readonly DependencyPropertyKey LeftSplitterWidthPropertyKey = DependencyProperty.RegisterReadOnly("LeftSplitterWidth", typeof(GridLength), typeof(DockTreeClientOverlay),
        new FrameworkPropertyMetadata());
    ...
    private static readonly DependencyPropertyKey RightSplitterWidthPropertyKey = DependencyProperty.RegisterReadOnly("RightSplitterWidth", typeof(GridLength), typeof(DockTreeClientOverlay),
        new FrameworkPropertyMetadata());
    ...
    private static readonly DependencyPropertyKey TopSplitterHeightPropertyKey = DependencyProperty.RegisterReadOnly("TopSplitterHeight", typeof(GridLength), typeof(DockTreeClientOverlay),
        new FrameworkPropertyMetadata());
    ...
    private static readonly DependencyPropertyKey BottomSplitterHeightPropertyKey = DependencyProperty.RegisterReadOnly("BottomSplitterHeight", typeof(GridLength), typeof(DockTreeClientOverlay),
        new FrameworkPropertyMetadata());
    ...
    private static readonly DependencyPropertyKey IsLeftGuideVisiblePropertyKey = DependencyProperty.RegisterReadOnly("IsLeftGuideVisible", typeof(bool), typeof(DockTreeClientOverlay),
        new FrameworkPropertyMetadata());
    ...
    private static readonly DependencyPropertyKey IsRightGuideVisiblePropertyKey = DependencyProperty.RegisterReadOnly("IsRightGuideVisible", typeof(bool), typeof(DockTreeClientOverlay),
        new FrameworkPropertyMetadata());
    ...
    private static readonly DependencyPropertyKey IsTopGuideVisiblePropertyKey = DependencyProperty.RegisterReadOnly("IsTopGuideVisible", typeof(bool), typeof(DockTreeClientOverlay),
        new FrameworkPropertyMetadata());
    ...
    private static readonly DependencyPropertyKey IsBottomGuideVisiblePropertyKey = DependencyProperty.RegisterReadOnly("IsBottomGuideVisible", typeof(bool), typeof(DockTreeClientOverlay),
        new FrameworkPropertyMetadata());
    ...
    private static readonly DependencyPropertyKey IsDocumentGuideVisiblePropertyKey = DependencyProperty.RegisterReadOnly("IsDocumentGuideVisible", typeof(bool), typeof(DockTreeClientOverlay),
        new FrameworkPropertyMetadata());
    ...
    private GridLength ConvertSplitterSize(bool isVisible)
    {
