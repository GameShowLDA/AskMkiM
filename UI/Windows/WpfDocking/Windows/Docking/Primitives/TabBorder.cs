...
namespace UI.Windows.WpfDocking.Windows.Docking.Primitives
{
  ...
  public class TabBorder : Decorator
  {
    private struct Points
    {
      ...
      private static double GetDeltaX(double radius, double angle)
      {
        return radius * Math.Sin(DegreeToRadians(angle));
      }

      private static double GetDeltaY(double radius, double angle)
      {
    ...
    private Geometry GetTrapezoidGeometry(Size size, double borderThickness)
    {
