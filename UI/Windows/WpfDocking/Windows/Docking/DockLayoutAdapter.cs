...
namespace UI.Windows.WpfDocking.Windows.Docking
{
  internal class DockLayoutAdapter
  {
    ...
    private Collection<Collection<DockItem>> _itemsCollections = new Collection<Collection<DockItem>>();
    private Collection<DockPane> _panes = new Collection<DockPane>();
    private Collection<DockPaneSplit> _splits = new Collection<DockPaneSplit>();
