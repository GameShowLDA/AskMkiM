...
namespace Ask.Core.Services.EventCore.Adapters
{
  ...
  public static class ExecutionEventAdapter
  {
    ...
    /// <summary>
    /// Публикует событие нажатия клавиши F4 для команды точки останова.
    /// </summary>
    /// <param name="commandInfo">Контекст команды, на которой была нажата F4.</param>
    public static void RaiseBreakpointF4Pressed(IExecutionCommandInfo commandInfo)
